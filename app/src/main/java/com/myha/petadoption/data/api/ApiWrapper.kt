...
sealed class ApiWrapper<T>(
    ...
    class Success<T>(data: T, headers: Headers, code: Int) :
        ApiWrapper<T>(data, headers, null, null, code)

    class ApiError<T>(message: String, error: String, code: Int, totalError: String) :
        ApiWrapper<T>(null, null, message, error, code, totalError)
